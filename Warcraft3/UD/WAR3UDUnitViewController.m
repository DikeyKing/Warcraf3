...
#import "WAR3UDUnit.h"
#import "WAR3UDUnitSkillCell.h"


@interface WAR3UDUnitViewController ()

@end

@implementation WAR3UDUnitViewController
...
- (void)viewDidLoad
{
    ...
    _unitDic = udUnit.deserializedArray[_selectedRow];
    ...
    /* 想不明白，在viewDidLoad中怎么设置都没有用
     _scrollView.frame = CGRectMake(0, 0, 320, 1050);
     _scrollView.ContentSize = CGSizeMake(320, 300+465+_skillNumber*140);
     _scrollView.contentOffset= CGPointMake(0, 0);
     */
    
    
    //  self.view.frame = CGRectMake(0, 0, 320, 465+_skillNumber*140);
    
    UINib *nib = [UINib nibWithNibName:@"WAR3UDUnitSkillCell" bundle:nil];
    
    [_unitSkillTableView registerNib:nib forCellReuseIdentifier:@"WAR3UDUnitSkillCell"];
    ...
    NSDictionary *dic = udUnit.deserializedArray[_selectedRow];
    ...
    [descriptionLabel setText:[dic objectForKey:@"description"]];
...
{
    WAR3UDUnitSkillCell *cell = [tableView dequeueReusableCellWithIdentifier:@"WAR3UDUnitSkillCell"];
