...
@interface WAR3UDHeroViewController ()
@end

@implementation WAR3UDHeroViewController
...
- (void)viewDidLoad
{
    ...
    [_heroSkillTableView registerNib:nib forCellReuseIdentifier:@"WAR3UDHeroSkillCell"];
    ...
    WAR3UDHero *UDHero = [WAR3UDHero new];
    [UDHero deserializedArray];
    
    _heroArray = UDHero.deserializedArray;
    _heroDic = UDHero.deserializedArray[_selectedRow];
...
{
    WAR3UDUnitSkillCell *cell = [tableView dequeueReusableCellWithIdentifier:@"WAR3UDHeroSkillCell"];
