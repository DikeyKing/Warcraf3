...
@interface WAR3HumanHeroViewController ()
@end

@implementation WAR3HumanHeroViewController
...
- (void)viewDidLoad
{
    ...
    [_heroSkillTableView registerNib:nib forCellReuseIdentifier:@"WAR3HumanHeroSkillCell"];
    ...
    WAR3HumanHero *humHero = [WAR3HumanHero new];
    [humHero deserializedArray];
    
    _heroArray = humHero.deserializedArray;
    _heroDic = humHero.deserializedArray[_selectedRow];
...
{
    WAR3HumanUnitSkillCell *cell = [tableView dequeueReusableCellWithIdentifier:@"WAR3HumanHeroSkillCell"];
