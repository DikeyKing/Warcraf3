//
//  WAR3OrcHeroViewController.m
//  Warcraft3
//
//  Created by Dikey on 4/23/14.
...
@interface WAR3OrcHeroViewController ()

@end

@implementation WAR3OrcHeroViewController
...
- (void)viewDidLoad
{
    ...
    [_heroSkillTableView registerNib:nib forCellReuseIdentifier:@"WAR3OrcHeroSkillCell"];
    ...
    WAR3OrcHero *orcHero = [WAR3OrcHero new];
    [orcHero deserializedArray];
...
{
    WAR3OrcUnitSkillCell *cell = [tableView dequeueReusableCellWithIdentifier:@"WAR3OrcHeroSkillCell"];
